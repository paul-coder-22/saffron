...
import questionObj from './questions.json'
import CustomCard from './Components/customCard';
import Card from 'react-bootstrap/Card';
import Button from 'react-bootstrap/Button';
import ListGroup from 'react-bootstrap/ListGroup';

const { passmark, questions } = questionObj

// shuffle Function
const reShuffleListFunc = (array) => {
...
const reshuffleQuestionList = reShuffleListFunc(questions);
